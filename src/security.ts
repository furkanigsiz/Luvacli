 ...
 */
export function checkPath(targetPath: string, cwd: string = process.cwd()): SecurityCheckResult {
 ...
 */
export function checkFileWrite(filePath: string, cwd: string = process.cwd()): SecurityCheckResult {
 ...
 */
export function checkFileDelete(filePath: string, cwd: string = process.cwd()): SecurityCheckResult {
  const pathCheck = checkPath(filePath, cwd);
  if (!pathCheck.allowed) {
    return pathCheck;
  }
...
let securityMode: "strict" | "normal" | "permissive" = "normal";

export function setSecurityMode(mode: "strict" | "normal" | "permissive"): void {
  securityMode = mode;
}
 ...
 * Güvenlik özeti
 */
export function getSecurityInfo(): string {
  return `
