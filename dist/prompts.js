 ...
 */
export function getBasePrompt(cwd) {
...
export function getAgentPlanPrompt(goal, codebaseContext) {
...
export function getAgentStepPrompt(goal, stepDescription, previousSteps, codebaseContext) {
    return `GÖREV: ${goal}
...
export function getFixErrorsPrompt(errors, codebaseContext) {
