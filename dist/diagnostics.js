 ...
 */
export async function getDiagnostics(filePaths) {
 ...
 */
async function getTypeScriptDiagnosticsForFile(filePath) {
    const diagnostics = [];
 ...
 */
async function getESLintDiagnosticsForFile(filePath) {
    const diagnostics = [];
    const dir = path.dirname(filePath);
    // Find eslint config
...
export async function runTypeScriptDiagnostics(rootDir) {
    const diagnostics = [];
...
export async function runESLintDiagnostics(rootDir) {
    const diagnostics = [];
    const resolved = path.resolve(rootDir);
...
// Run all diagnostics
export async function runAllDiagnostics(rootDir) {
    const allDiagnostics = [];
    const summaries = [];
    // TypeScript
